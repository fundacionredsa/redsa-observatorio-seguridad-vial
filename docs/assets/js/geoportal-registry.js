(function () {
    const variables = {
        ...
        fallecidos_inec_2019: {
            label: "Personas fallecidas por siniestros (registro civil)",
            displayLabel: "Personas fallecidas por siniestros",
            categoria: "Mortalidad",
            fuenteCorta: "INEC / EDG (Registro Civil)",
            fuente: "INEC, Registro Estadístico de Defunciones Generales (EDG)",
            description: "Número de personas que murieron por siniestros de tránsito.",
        ...
        tasa_siniestros_1000_vehiculos_2024: {
            label: "Siniestros por cada 1.000 vehículos (2024)",
            displayLabel: "Siniestros por cada 1.000 vehículos",
            categoria: "Indicadores Relativos",
            fuenteCorta: "Cálculo REDSA / INEC ESTRA 2024",
            fuente: "Cálculo REDSA con INEC ESTRA 2024",
            description: "Siniestros por cada 1.000 vehículos matriculados: mide el riesgo según la cantidad de vehículos, no solo de personas.",
            unidad: "siniestros por cada 1.000 vehículos matriculados",
            metodologia: "Siniestros reportados en 2024 divididos para vehículos matriculados en 2024, multiplicado por 1.000. Los vehículos se asignan por residencia del propietario, no por lugar de circulación.",
            licencia: "Creative Commons Atribución 4.0 (fuente INEC)",
            referencias: [
        ...
        fallecidos_sppat_2016_2021: {
            ...
            description: "Fallecidos según reclamos del seguro obligatorio de siniestros de tránsito (2016-2021).",
        ...
        fallecidos_parroquial: {
            ...
            fuente: "INEC, Registro Estadístico de Defunciones Generales (EDG)",
            description: "Personas fallecidas por siniestros de tránsito según el registro civil (EDG), comparables entre provincia, cantón y parroquia.",
            unidad: "personas fallecidas",
