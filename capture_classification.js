...
(async () => {
    ...
    const server = spawn('node', ['-e', `
        ...
        const fs = require('fs');
        const path = require('path');
        const dir = 'C:\\\\Users\\\\Admin\\\\Documents\\\\023_REDSA_ObservatorioSeguridadVial\\\\redsa-observatorio-seguridad-vial\\\\docs';
    ...
    try {
        ...
        async function captureVariable(variableId, level, basemapIndex, filename) {
            await page.selectOption('#indicator-select', variableId);
